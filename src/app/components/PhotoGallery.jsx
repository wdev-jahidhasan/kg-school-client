  ...
  return (
    <section className="py-12 sm:py-16 lg:py-24 bg-white dark:bg-slate-950 w-full relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
        ...
        {/* Category Filters */}
        <div className="flex flex-wrap justify-center items-center gap-2.5 sm:gap-3 mb-8 sm:mb-10">
        ...
        <motion.div
          layout
          className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 auto-rows-[200px] sm:auto-rows-[250px]"
        >
          <AnimatePresence>
